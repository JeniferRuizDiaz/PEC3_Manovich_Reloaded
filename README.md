...
Així doncs, per entendre millor aquest concepte, podríem fer un paral·lelisme amb els colors. D'una banda, tenim el color groc i, de l'altra, el color blau, dos colors diferents amb identitat pròpia. En el cas de la multimèdia, aquests colors es mostrarien de forma contigua. No obstant això, en la hibridació, fusionaríem aquests colors per obtenir-ne un de nou totalment diferent: el color verd, que no podríem obtenir si no féssim aquesta barreja. En els mitjans digitals, aquesta combinació es pot realitzar de moltes maneres, tantes com mitjans i aplicacions existeixen actualment.
